...
const SAOLA={
 ...
 traits:[
  {title:'Cornos longos e paralelos',text:'Machos e fêmeas possuem dois cornos quase paralelos que podem atingir cerca de 50 cm.',crop:'50% 18%',detailImage:COMMONS+encodeURIComponent('Pseudoryx nghetinhensis.PNG')},
  ...
  {title:'Grandes glândulas faciais',text:'Possui glândulas maxilares muito desenvolvidas, provavelmente usadas em comunicação química.',crop:'50% 36%',detailImage:COMMONS+encodeURIComponent('Pseudoryx nghetinhensis.PNG')}
 ],
 dietItems:['Folhas','Rebentos','Plantas herbáceas','Vegetação ribeirinha','Folhas de arbustos'],dietIconKeys:['leaf','shoot','leaf','leaf','leaf'],
